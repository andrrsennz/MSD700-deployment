...
ROS2D.Rotate.prototype.startRotate = function(deg) {
  // this.stage.regX = regx/2;
  // this.stage.regY = regy/2;
  this.stage.rotation += deg;

};

ROS2D.Rotate.prototype.resetRotate = function() {
